...
const InputWithLabel = ({id, children, value, type = "text", isFocused, onInputChange}) => {
    ...
    return (
        <>
            ...
            &nbsp;
            <input className={styles.input} ref={inputRef} id={id} type={type} value={value} autoFocus={isFocused} onChange={onInputChange}/>
        </>
    )
}
...
const SearchForm = ({searchTerm, onSearchInput, onSearchSubmit}) => (
    <form className={styles.searchForm} onSubmit={onSearchSubmit}>
        ...
        <button className={`${styles.button} ${styles.buttonLarge}`} type={"submit"} disabled={!searchTerm}>
            Submit
        </button>
    </form>
